...
beautiful.init("/home/ajayraj/.config/awesome/theme.lua")
...
globalkeys = gears.table.join(
    ...
    awful.key({modkey, "Shift"}, "d", function () xrandr.xrandr() end,
              {description = "dual monitor", group = "Monitors"}),
...
awful.rules.rules = {
    ...
    -- Set Thunderbird to always map on the tag named "3" on screen 2.
...
awful.util.spawn_with_shell("pgrep -u $USER -x xfce4-power-manager > /dev/null || (xfce4-power-manager &)")
